import { createOrbitDB, KeyValueIndexed } from '@orbitdb/core'
...
;(async () => {
  ...
  const db1 = await orbitdb.open('benchmark-keyvalue-indexed', { Database: KeyValueIndexed(), encryption: { replicationEncryption, dataEncryption } })
